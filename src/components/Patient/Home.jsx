...
function Home() {
  ...
  return (
    <div className='bg-gradient-to-b from-blue-50 via-blue-100 to-blue-200 min-h-screen'>
        <section>
            <div className='flex flex-col lg:flex-row h-screen w-screen justify-center items-center max-w-7xl m-auto'>
                ...
                className='flex flex-col justify-center'> 
                    <p className='text-3xl font-semibold text-center text-blue-800'>Where Every Life Matters Most</p> 
                    <p className='text-lg text-center text-gray-600'>To Undertake Specialized And holistic healthcare
                ...
                transition={{ duration: 1.5 }}
                whileInView={{ opacity: 1 }}
                className='w-full md:w-[80%] lg:w-[100%] ml-8'><img src={banner} alt="hero"  className='h-[400px] shadow-black'/></motion.div>
            </div>
        
        </section>
        <motion.section>
            <div className='w-full h-full flex flex-col justify-center items-center bg-gradient-to-b from-blue-100 to-blue-200 py-16'>
                <p className='font-semibold text-3xl text-blue-800 mb-8'>Why Choose Us?</p>
                <div className='flex flex-col md:flex-row justify-center items-center gap-8'>
                    <div className='w-[350px] h-[300px] md:h-[350px] flex flex-col justify-evenly md:justify-between bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300'>
                                <motion.div  
                                ref={ref}
                initial={{ opacity: 0,}} 
                animate={{ opacity: inView ? 1 : 0,  }} 
                ...
                whileInView={{ opacity: 1 }}>
                    ...
                    <div className='hidden md:block'><img src={service} alt="services" className='h-[400px] rounded-lg shadow-lg' /></div>
                    <div className='md:ms-3 w-[350px] h-[250px] md:h-[350px] flex flex-col justify-evenly md:justify-between bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300'>
                                <motion.div  
                                ref={ref}
                initial={{ opacity: 0,  }} 
                animate={{ opacity: inView ? 1 : 0,  }} 
        ...
        transition={{ duration: 1.5 }}
        whileInView={{ opacity: 1 }}
        className='bg-gradient-to-b from-blue-100 to-blue-200 py-16'
        >
            <div className='h-full max-w-7xl flex flex-col m-auto justify-center items-center overflow-auto'>
                <p className='font-semibold text-3xl text-blue-800 mb-8'>Meet Our Specialist</p>
                <div className='flex flex-col gap-4'>
                    <div className='flex gap-4 flex-wrap justify-center'>
                        <div className="w-[270px] h-[300px] border border-gray-200 rounded-lg bg-white/80 backdrop-blur-sm shadow-lg hover:shadow-xl transition-shadow duration-300 flex justify-center">
                            <div className="flex flex-col items-center justify-center p-4">
                                <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src={human1} alt=""/>
                                <h5 className="mb-1 text-xl font-medium text-blue-800">Dr.Rahul Singh</h5>
                                <span className="text-sm text-gray-600">Surgeon</span>
                                <div className="flex mt-4 md:mt-6">
                                <a href="/appointment" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 transition-colors duration-300">Book Appointment</a>
                                </div>
                            </div>
                        </div>

                        <div className="w-[270px] h-[300px] bg-white border border-gray-200 rounded-lg shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src={doct1} alt=""/>
                                <h5 className="mb-1 text-xl font-medium text-blue-800">Dr.Ramesh Chand</h5>
                                <span className="text-sm text-gray-600">Surgeon</span>
                                <div className="flex mt-4 md:mt-6">
                                <a href="/appointment" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 transition-colors duration-300 ms-3">Book Appointment</a>
                                </div>
                            </div>
                        </div>
                        <div className="w-[270px] h-[300px] bg-white border border-gray-200 rounded-lg shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                ...
                                <h5 className="mb-1 text-xl font-medium text-blue-800">Dr.Maxwell Honda</h5>
                                <span className="text-sm text-gray-600">Surgeon</span>
                                <div className="flex mt-4 md:mt-6">
                                <a href="/appointment" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 transition-colors duration-300 ms-3">Book Appointment</a>
                                </div>
                        ...
                        <div className="w-[270px] h-[300px] bg-white border border-gray-200 rounded-lg shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                ...
                                <h5 className="mb-1 text-xl font-medium text-blue-800">Dr.Selena Gomez</h5>
                                <span className="text-sm text-gray-600">Surgeon</span>
                                <div className="flex mt-4 md:mt-6">
                                <a href="/appointment" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 transition-colors duration-300 ms-3">Book Appointment</a>
                                </div>
                    ...
                    <div className='flex gap-4 flex-wrap justify-center'>
                        <div className="w-[270px] h-[300px] bg-white border border-gray-200 rounded-lg shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                ...
                                <h5 className="mb-1 text-xl font-medium text-blue-800">Dr.Victor Suresh</h5>
                                <span className="text-sm text-gray-600">Surgeon</span>
                                <div className="flex mt-4 md:mt-6">
                                <a href="/appointment" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 transition-colors duration-300 ms-3">Book Appointment</a>
                                </div>
                        ...
                        <div className="w-[270px] h-[300px] bg-white border border-gray-200 rounded-lg shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                ...
                                <h5 className="mb-1 text-xl font-medium text-blue-800">Dr.Mahesh Dalla</h5>
                                <span className="text-sm text-gray-600">Surgeon</span>
                                <div className="flex mt-4 md:mt-6">
                                <a href="/appointment" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 transition-colors duration-300 ms-3">Book Appointment</a>
                                </div>
                        ...
                        <div className="w-[270px] h-[300px] bg-white border border-gray-200 rounded-lg shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                ...
                                <h5 className="mb-1 text-xl font-medium text-blue-800">Dr.Sasuke Uchiha</h5>
                                <span className="text-sm text-gray-600">Surgeon</span>
                                <div className="flex mt-4 md:mt-6">
                                <a href="/appointment" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 transition-colors duration-300 ms-3">Book Appointment</a>
                                </div>
                        ...
                        <div className="w-[270px] h-[300px] bg-white border border-gray-200 rounded-lg shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                ...
                                <h5 className="mb-1 text-xl font-medium text-blue-800">Dr.Miku Uzumaki</h5>
                                <span className="text-sm text-gray-600">Surgeon</span>
                                <div className="flex mt-4 md:mt-6">
        ...
        <section>
            <div className='max-w-7xl m-auto flex flex-col justify-center gap-8 items-center w-full h-full overflow-auto bg-gradient-to-b from-blue-50 to-blue-100 py-16'>
                <motion.div
                ref={ref}
                initial={{ opacity: 0 }} 
                animate={{ opacity: inView ? 1 : 0 }} 
                ...
                whileInView={{ opacity: 1 }}
                 className='flex flex-col justify-center items-center'>
                    <p className='text-3xl font-semibold text-blue-800'>Our Patients Feedback About Us</p>
                    <p className='text-sm text-center text-gray-600'>A hospital is a healthcare institution providing patient treatment with specialized health science and auxiliary healthcare staff and medical equipment.</p>
                </motion.div>
                <motion.div
                ref={ref}
                initial={{ opacity: 0}} 
                ...
                className='flex items-center gap-4'>
                    ...
                    <div className='flex flex-col items-start py-5 p-5 w-[450px] shadow-xl bg-white/80 backdrop-blur-sm rounded-lg'>
                        ...
                        <div>
                            <p className=''>I have visited many hospitals but CureWell has to be one of the finest anywhere in the world. </p>
                            <p>From the International desk to the private executive room, service and hospitality has been excellent.</p>
                            <p> I would highly recommend CureWell to all. Once again many thanks for your help.</p>
                        </div>
                    </div>
                </motion.div>
            </div>
        </section>
        <section className='bg-gradient-to-b from-blue-100 to-blue-200'>
            <div className='absolute lg:m-56 md:m-36 sm:m-24 m-20 overflow-hidden'>
                ...
                className="mx-auto max-w-7xl px-2 py-10 lg:px-0 z-10">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between bg-white/80 backdrop-blur-sm rounded-xl p-8 shadow-lg">
                                <div className="w-full md:w-2/3 lg:w-1/2">
                                <h2 className="text-3xl font-bold text-black">Sign up for our weekly newsletter</h2>
                                <p className="mt-4 text-gray-600">
                        Be sure to check out and subscribe to the newsletters of CureWell to stay updated about the developments in healthcare field.  
                                </p>
                                <div className="mt-4">
