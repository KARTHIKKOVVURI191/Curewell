...
function ContactUs() {
  ...
  return (
    <>
      <section className='pt-[80px] bg-blue-50'>
        <motion.div
          ref={ref}
          initial={{ opacity: 0 }} 
          ...
          <div className='z-10 bottom-0 hidden lg:block lg:left-32 py-4 rounded-t-lg lg:w-[400px] text-center bg-blue-100 absolute'>
            <p className='font-semibold text-3xl text-blue-800'>Contact Us</p>
          </div>
        </motion.div>
      </section>
        ...
        <div className="flex gap-10 mx-14 py-14">
          <div className="flex-col hidden md:flex">
            ...
            <span className="text-zinc-550 text-2xl">
                CureWell Vijayawada - India
            </span>
            <span className="text-zinc-500 text-base">
                CureWell, Gandhi Nagar, Vijayawada – 520009, Andhra Pradesh,
              India
            </span>
            <br />
            ...
            <div className="flex flex-col">
              <span className="text-zinc-650 text-2xl">Email</span>
                <span className="text-zinc-500 text-base">feedback@curewell.org</span>
              </div>
          ...
          transition={{ duration: 1.5 }}
          whileInView={{ opacity: 1 }}
              className="flex flex-col w-[500px] h-4/5 p-4 justify-center items-center bg-white/80 backdrop-blur-sm gap-10 border border-black broder-2 rounded-lg border-transparent shadow-xl shadow-slate-950">
            ...
            <button
              ...
              type="button"
                className="rounded-md bg-blue-600 px-10 py-3 text-lg font-semibold text-white shadow-sm hover:scale-105 duration-150 active:scale-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
            >
              Submit
            </button>
          </motion.div>
